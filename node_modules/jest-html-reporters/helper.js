...
exports.pickData = exports.getOptions = exports.readAttachInfos = exports.addMsg = exports.addAttach = exports.resourceDirName = exports.attachDirPath = exports.dataDirPath = exports.tempDirPath = void 0;
...
exports.tempDirPath = path_1.default.resolve(process.env.JEST_HTML_REPORTERS_TEMP_DIR_PATH || os_1.default.tmpdir(), "".concat(username, "-").concat(process.ppid), 'jest-html-reporters-temp');
...
var addAttach = function (_a) {
    var attach = _a.attach, description = _a.description, context = _a.context, _b = _a.bufferFormat, bufferFormat = _b === void 0 ? 'jpg' : _b;
    return __awaiter(void 0, void 0, void 0, function () {
        var _c, testPath, testName, createTime, fileName, attachObject, path_2, attachObject, err_1;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    attachObject = { createTime: createTime, testPath: testPath, testName: testName, filePath: attach, description: description, extName: path_1.default.extname(attach) };
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    createTime = Date.now();
                    fileName = generateRandomString();
                    attachObject = { createTime: createTime, testPath: testPath, testName: testName, description: message };
                    return [4 /*yield*/, fs_extra_1.default.writeJSON("".concat(exports.dataDirPath, "/").concat(fileName, ".json"), attachObject)];
                case 1:
                    _c.sent();
                    return [2 /*return*/];
...
var readAttachInfos = function (publicPath) { return __awaiter(void 0, void 0, void 0, function () {
    var result, exist, attachData, dataList, outPutDir, attachFiles, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                dataList = _a.sent();
                outPutDir = path_1.default.resolve(publicPath, exports.resourceDirName);
                return [4 /*yield*/, fs_extra_1.default.readdir(exports.attachDirPath)];
            case 5:
                attachFiles = _a.sent();
                if (!attachFiles.length) return [3 /*break*/, 7];
                return [4 /*yield*/, fs_extra_1.default.copy(exports.attachDirPath, outPutDir)];
            case 6:
                _a.sent();
                _a.label = 7;
            case 7:
                dataList.forEach(function (attachObject) {
                    ...
                    result[testPath][attachMappingName].push({
                        filePath: fileName ? "".concat(exports.resourceDirName, "/").concat(fileName) : filePath,
                        description: description || '',
                        createTime: createTime,
                        extName: extName,
                    });
...
var constants = {
    ...
    DEFAULT_OPTIONS: (_a = {},
        ...
        _a[TEST_COMMAND] = 'npx jest',
        _a[OPEN_REPORT] = process.env.NODE_ENV === 'development',
        _a[FAILURE_MESSAGE_ONLY] = false,
...
var pickData = function (obj, filterKeys) {
    var res = {};
